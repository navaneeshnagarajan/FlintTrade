...
- **Version:** 0.5.0-dev — Post-Wave 47 (build sessions 2026-04-07/08/09)
- **Tests:** 2,440 terminal (Vitest, 223 files) + ~6,300 Python (pytest) = ~8,740 total
- **Terminal:** 76 widgets (TSX) + 7 tools + 13 routes + 6 workspace presets in Dockview v5.1 shell
