...
- **Version:** 0.5.0-dev — Post-Wave 35 (build sessions 2026-04-07/08/09)
- **Tests:** 1,910 terminal (Vitest, 180 files) + ~5,500 Python (pytest) = ~7,410 total
- **Terminal:** 34 widgets (TSX) + 7 tools + 13 routes + 6 workspace presets in Dockview v5.1 shell
