...
- **Version:** 0.5.0-dev — Post-Wave 37 (build sessions 2026-04-07/08/09)
- **Tests:** 1,967 terminal (Vitest, 183 files) + ~5,600 Python (pytest) = ~7,567 total
- **Terminal:** 37 widgets (TSX) + 7 tools + 13 routes + 6 workspace presets in Dockview v5.1 shell
