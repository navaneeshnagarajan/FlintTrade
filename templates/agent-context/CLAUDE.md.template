...
- **Version:** 0.5.2-dev (tag `v0.5.2-dev`, 2026-05-20) — SemVer release-hygiene prerelease snapshot. Latest stable remains `v0.5.1` (security hardening + CI stability patch release, 65 commits after v0.5.0). See `docs/RELEASE_NOTES_v0.5.1.md` and `docs/RELEASE_NOTES_v0.5.2-dev.md`.
...
For the complete list of upstream projects and libraries, see `docs/REFERENCES.md`. For the ~215 cloned reference repositories absorbed into FlintTrade (broker gateway, strategy templates, UI patterns, AI agents), see `.local/reference/REPO_FEATURE_MAP.md`.
