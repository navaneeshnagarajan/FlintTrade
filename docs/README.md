...
| [acceptance/](acceptance/) | Maintainer | Tracking PASS bars. [FT-MONDAY-002](acceptance/FT-MONDAY-002.md) locks native Dhan + Neo MSI Connected (read) / API smoke (product tip; native HTTP freeze stays). |
