...
6. **TEST** — `npx vitest run` (978+ pass), `make test` (2,651+ pass), `ruff check`
...
| Job | What it checks |
|---|---|
| `python-tests` | pytest (2,651+ tests) + ruff lint |
| `node-tests` | tsc strict + vitest (978+) + production build |
