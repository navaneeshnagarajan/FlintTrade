...
6. **TEST** — `npx vitest run` (1,062+ pass), `make test` (2,903+ pass), `ruff check`
...
| Job | What it checks |
|---|---|
| `python-tests` | pytest (2,903+ tests) + ruff lint |
| `node-tests` | tsc strict + vitest (1,062+) + production build |
