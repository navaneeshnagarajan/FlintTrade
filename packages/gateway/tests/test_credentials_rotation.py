"""Tests for packages/gateway/src/credentials_rotation.py.

Covers: scheduling, immediate rotation, status queries, error handling.

Run with:
    python -m pytest packages/gateway/tests/test_credentials_rotation.py -v --import-mode=importlib
"""
...
from packages.gateway.src.credentials_rotation import (
    CredentialsRotator,
    RotationResult,
)
