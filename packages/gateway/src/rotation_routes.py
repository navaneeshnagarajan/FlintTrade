...
Usage::
    ...
    from packages.gateway.src.rotation_routes import create_rotation_blueprint
...
def create_rotation_blueprint(rotator: object) -> Blueprint:
    ...
    Args:
        rotator: A :class:`~packages.gateway.src.credentials_rotation.CredentialsRotator`
            instance.
