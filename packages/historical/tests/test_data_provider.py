"""Tests for packages/historical/src/data_provider.py.
...
class TestNormaliseInterval:
    ...
    def test_canonical_passthrough(self):
        from packages.historical.src.data_provider import normalise_interval
    ...
    def test_all_mapped_intervals(self):
        from packages.historical.src.data_provider import INTERVAL_MAP
...
class TestProviderResult:
    ...
    def test_success_with_bars(self):
        from packages.historical.src.data_provider import ProviderBar, ProviderResult
        bars = [
    ...
    def test_failure_with_error(self):
        from packages.historical.src.data_provider import ProviderResult
...
class TestOpenAlgoProvider:
    ...
    def _make_provider(self, bars=None, errors=None):
        from packages.historical.src.data_provider import OpenAlgoProvider
        mock_client = MagicMock()
        provider = OpenAlgoProvider(mock_client)
        return provider, mock_client

    def test_supports_all_openalgo_exchanges(self):
        from packages.historical.src.data_provider import OpenAlgoProvider, OPENALGO_EXCHANGES
        mock_client = MagicMock()
        provider = OpenAlgoProvider(mock_client)
    ...
    def test_fetch_success(self):
        ...
        with patch("packages.historical.src.downloader.HistoricalDownloader") as MockDL:
            ...
            with patch.dict("sys.modules"):
                import packages.historical.src.downloader as dl_mod
...
class TestOpenChartProvider:
    ...
    def test_supports_nse_nfo(self):
        from packages.historical.src.data_provider import OpenChartProvider
        p = OpenChartProvider()
    ...
    def test_fetch_success(self):
        from packages.historical.src.data_provider import OpenChartProvider
        from packages.historical.src.free_data import FreeDataResult, FreeBar
        import packages.historical.src.free_data as fd_mod
...
class TestYFinanceProvider:
    ...
    def test_supports_mcx(self):
        from packages.historical.src.data_provider import YFinanceProvider
    ...
    def test_fetch_failure(self):
        from packages.historical.src.data_provider import YFinanceProvider
        from packages.historical.src.free_data import FreeDataResult
        import packages.historical.src.free_data as fd_mod
...
class TestProviderRegistry:
    ...
    def test_fetch_uses_first_supporting_provider(self):
        from packages.historical.src.data_provider import ProviderRegistry, ProviderBar, ProviderResult
    ...
    def test_no_fallback_returns_first_error(self):
        from packages.historical.src.data_provider import ProviderRegistry, ProviderResult
    ...
    def test_protocol_compliance(self):
        ...
        from packages.historical.src.data_provider import (
            DataProvider,
            OpenAlgoProvider,
            OpenChartProvider,
            YFinanceProvider,
