...
class TestExpiryDataResult:
    ...
    def test_empty_result(self):
        from packages.historical.src.expiry_collector import ExpiryDataResult
        result = ExpiryDataResult(symbol="NIFTY", expiry="260327", exchange="NFO")
        assert result.total_bars == 0
        assert not result.success

    def test_result_with_records(self):
        from packages.historical.src.expiry_collector import (
            ExpiryDataRecord,
            ExpiryDataResult,
        )
...
class TestExpiryDataRecord:
    ...
    def test_default_values(self):
        from packages.historical.src.expiry_collector import ExpiryDataRecord
...
class TestGetPastExpiries:
    ...
    def test_filters_to_past_dates(self):
        ...
        with patch("packages.historical.src.expiry_collector.date") as mock_date:
