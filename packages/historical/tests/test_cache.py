"""Tests for packages/historical/src/cache.py.
...
class TestTTL:
    ...
    def test_is_fresh_within_ttl(self):
        from packages.historical.src.cache import CacheEntry, OHLCVCache
...
class TestCacheResult:
    ...
    def test_success_with_bars(self):
        from packages.historical.src.cache import CacheResult
        result = CacheResult(
            symbol="X", exchange="NSE", interval="5m",
