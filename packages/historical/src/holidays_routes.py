...
Uses :mod:`packages.engine.src.market_hours` for local special-session data
and :class:`packages.core.src.openalgo_client.OpenAlgoClient` for live
...
def get_timings() -> tuple[Any, int]:
    ...
    try:
        from packages.engine.src.market_hours import (  # noqa: PLC0415
            get_standard_hours,
