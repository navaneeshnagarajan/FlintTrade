"""Tests for packages/ai/src/team_routes.py (Flask Blueprint).
...
def reset_team_singleton():
    ...
    """
    import packages.ai.src.team_routes as _mod
...
def app():
    ...
    """
    from packages.ai.src.team_routes import team_bp
...
class TestTeamAnalyse:
    def test_no_llm_returns_503(self, client) -> None:
        ...
        """
        with patch("packages.ai.src.team_routes._get_team", return_value=None):
            resp = client.post(
    ...
    def test_missing_symbol_returns_400(self, client) -> None:
        ...
        """
        team = _make_team()
        with patch("packages.ai.src.team_routes._get_team", return_value=team):
            resp = client.post(
                "/api/v1/ai/team/analyse",
...
class TestTeamConfigGet:
    def test_config_with_no_team_returns_defaults(self, client) -> None:
        ...
        with (
            patch("packages.ai.src.team_routes._get_team", return_value=None),
            patch("packages.ai.src.multi_agent.default_agents", return_value=mock_default_agents),
        ):
