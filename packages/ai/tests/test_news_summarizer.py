...
class TestNewsSummary:
    ...
    def test_success_when_content_present(self):
        from packages.ai.src.news_summarizer import NewsSummary
        summary = NewsSummary(
...
class TestMarketNewsSummarizerInit:
    ...
    def test_creates_with_default_llm(self):
        ...
        from packages.ai.src.news_summarizer import MarketNewsSummarizer
...
class TestFetchNews:
    ...
    def test_fetch_returns_articles(self):
        ...
        with patch.dict("sys.modules", {"feedparser": MagicMock(parse=MagicMock(return_value=mock_feed))}):
            import importlib
            import packages.ai.src.news_summarizer as ns
            importlib.reload(ns)
...
class TestArticlesToText:
    ...
    def test_formats_articles(self):
        from packages.ai.src.news_summarizer import _articles_to_text
...
class TestSectorKeywords:
    ...
    def test_all_major_sectors_defined(self):
        from packages.ai.src.news_summarizer import SECTOR_KEYWORDS
