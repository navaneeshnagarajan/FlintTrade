...
class TestGenerateSharpeLabels:
    ...
    def test_output_length_matches_offset(self):
        from packages.ai.src.signals import generate_sharpe_labels
    ...
    def test_package_export(self):
        from packages.ai.src import generate_sharpe_labels
...
class TestComputeTurbulence:
    ...
    def test_package_export(self):
        from packages.ai.src import compute_turbulence
...
class TestPipelineTurbulenceIntegration:
    ...
    def test_turbulence_disabled_by_default(self):
        from packages.ai.src.pipeline import SignalPipeline
