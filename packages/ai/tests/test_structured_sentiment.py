...
class TestMarketSummarySchema:
    def test_schema_has_required_fields(self):
        from packages.ai.src.structured_sentiment import MARKET_SUMMARY_SCHEMA
    ...
    def test_market_sentiment_enum_values(self):
        from packages.ai.src.structured_sentiment import MARKET_SUMMARY_SCHEMA, SentimentLabel
...
class TestMarketSummaryModel:
    def test_valid_payload_parses(self):
        from packages.ai.src.structured_sentiment import MarketSummary
    ...
    def test_label_normalised_to_uppercase(self):
        from packages.ai.src.structured_sentiment import MarketSummary, SentimentLabel
...
class TestSentimentLabelFromScore:
    ...
    def test_score_to_label_boundaries(self, score: float, expected: str):
        from packages.ai.src.structured_sentiment import sentiment_label_from_score

        result = sentiment_label_from_score(score)
        assert result.value == expected

    def test_out_of_range_clamped(self):
        from packages.ai.src.structured_sentiment import (
            SentimentLabel,
...
class TestGenerateMarketSummary:
    def test_returns_market_summary_on_valid_response(self):
        from packages.ai.src.structured_sentiment import MarketSummary, generate_market_summary
...
class TestSubModels:
    def test_index_snapshot_fields(self):
        from packages.ai.src.structured_sentiment import IndexSignal, IndexSnapshot
    ...
    def test_sector_outlook_fields(self):
        from packages.ai.src.structured_sentiment import SectorOutlook
    ...
    def test_fii_dii_flow_fields(self):
        from packages.ai.src.structured_sentiment import FiiDiiFlow
