...
class TestSentimentAnalyseDeep:
    ...
    @patch("packages.ai.src.sentiment.score_article_with_llm")
    ...
    @patch("packages.ai.src.ai_routes._is_llm_configured", return_value=True)
    @patch("packages.ai.src.sentiment.score_article_with_llm")
    @patch("packages.ai.src.sentiment.score_article_rule_based")
    @patch("packages.ai.src.llm_client.LLMClient")
...
class TestRefineStrategyDeep:
    ...
    @patch("packages.ai.src.strategy_refiner.StrategyRefiner")
