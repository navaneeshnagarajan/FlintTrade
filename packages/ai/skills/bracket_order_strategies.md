...
Note: `stoploss`, `squareoff`, and `trailing_stoploss` are in points/ticks, not prices. Confirm parameter names with your broker's OpenAlgo adapter — not all 33 brokers support trailing SL.
