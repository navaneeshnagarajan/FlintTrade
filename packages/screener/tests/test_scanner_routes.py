"""Tests for packages/screener/src/scanner_routes.py (Flask Blueprint).
...
def app():
    ...
    """
    from packages.screener.src.scanner_routes import scanner_bp
...
class TestScannerRun:
    def test_run_prebuilt_success(self, client) -> None:
        ...
        with patch(
            "packages.screener.src.scanner_routes._scanner.scan",
