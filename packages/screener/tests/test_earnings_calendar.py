...
Run with:
    python -m pytest packages/screener/tests/test_earnings_calendar.py -v --import-mode=importlib
"""
...
class TestEarningsEvent:
    ...
    def _make_event(self, **kwargs):
        from packages.screener.src.earnings_calendar import EarningsEvent
...
class TestEarningsCalendar:
    ...
    def test_get_by_date_sorted_by_symbol(self, cal):
        ...
        from packages.screener.src.earnings_calendar import EarningsEvent, EarningsCalendar
...
def route_client(_restore_env):
    ...
    from packages.screener.src.earnings_calendar import EarningsCalendar
    import packages.screener.src.earnings_routes as _mod
