...
def _make_cache():
    from packages.screener.src.stock_cache import StockCache
...
class TestParseCompanyPage:
    ...
    def test_parses_company_name(self):
        from packages.screener.src.fundamental_screener import _parse_company_page
...
class TestParseNumber:
    ...
    def test_plain_number(self):
        from packages.screener.src.fundamental_screener import _parse_number
...
class TestCacheIntegration:
    ...
    def test_update_cache_and_retrieve(self):
        from packages.screener.src.fundamental_screener import FundamentalData
    ...
    def test_cache_to_fundamental_roundtrip(self):
        from packages.screener.src.fundamental_screener import FundamentalScreener
        from packages.screener.src.stock_cache import StockFundamentals
