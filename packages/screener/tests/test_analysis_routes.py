...
class TestGEXEndpoint:
    """Tests for POST /ft-api/v1/gex."""

    def test_gex_returns_200(self, client):
        resp, body = _post(client, "/ft-api/v1/gex", {"symbol": "NIFTY", "exchange": "NFO", "expiry": "26MAR26"})
        assert resp.status_code == 200

    def test_gex_status_ok(self, client):
        _, body = _post(client, "/ft-api/v1/gex", {"symbol": "NIFTY", "exchange": "NFO"})
    ...
    def test_gex_symbol_in_response(self, client):
        _, body = _post(client, "/ft-api/v1/gex", {"symbol": "BANKNIFTY", "exchange": "NFO"})
...
class TestVolSurfaceEndpoint:
    """Tests for POST /ft-api/v1/volsurface."""

    def test_volsurface_returns_200(self, client):
        resp, _ = _post(client, "/ft-api/v1/volsurface", {
    ...
    def test_volsurface_status_ok(self, client):
        _, body = _post(client, "/ft-api/v1/volsurface", {
...
class TestIVSmileEndpoint:
    """Tests for POST /ft-api/v1/ivsmile."""

    def test_ivsmile_returns_200(self, client):
        resp, _ = _post(client, "/ft-api/v1/ivsmile", {
            "symbol": "NIFTY", "exchange": "NFO", "expiry": "26MAR26",
        })
        assert resp.status_code == 200

    def test_ivsmile_status_ok(self, client):
        _, body = _post(client, "/ft-api/v1/ivsmile", {"symbol": "NIFTY", "exchange": "NFO"})
        assert body["status"] == "ok"
...
class TestStraddlePnLEndpoint:
    """Tests for POST /ft-api/v1/straddlepnl."""

    def test_straddlepnl_returns_200(self, client):
        resp, _ = _post(client, "/ft-api/v1/straddlepnl", {
            "symbol": "NIFTY", "exchange": "NFO", "expiry": "26MAR26",
    ...
    def test_straddlepnl_status_ok(self, client):
        _, body = _post(client, "/ft-api/v1/straddlepnl", {"symbol": "NIFTY"})
        assert body["status"] == "ok"
...
class TestMaxPainEndpoint:
    """Tests for POST /ft-api/v1/maxpain."""

    def test_maxpain_returns_200(self, client):
        resp, _ = _post(client, "/ft-api/v1/maxpain", {
            "symbol": "NIFTY", "exchange": "NFO", "expiry": "26MAR26",
        })
        assert resp.status_code == 200

    def test_maxpain_status_ok(self, client):
        _, body = _post(client, "/ft-api/v1/maxpain", {"symbol": "NIFTY"})
        assert body["status"] == "ok"
