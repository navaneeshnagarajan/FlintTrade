"""Tests for packages/screener/src/stock_routes.py — stock screener scan endpoint."""
...
import packages.screener.src.stock_routes as mod
...
def test_stock_scan_ok(client):
    ...
    with patch("packages.screener.src.stock_routes._get_cache", return_value=mock_cache):
