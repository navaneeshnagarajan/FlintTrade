...
Run with: python -m pytest packages/screener/tests/test_lot_sizes.py -v --import-mode=importlib
"""
...
class TestModuleExports:
    def test_lot_sizes_exported_from_screener(self):
        from packages.screener.src import FALLBACK_LOT_SIZES, LotSizeResolver, get_lot_size_sync
