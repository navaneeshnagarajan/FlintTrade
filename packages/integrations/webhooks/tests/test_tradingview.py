...
class TestTradingViewAlertDataclass:
    def test_default_values(self):
        from flinttrade_webhooks.tradingview import TradingViewAlert
        a = TradingViewAlert()
        assert a.action == ""
...
class TestValidConstants:
    def test_valid_exchanges_include_nfo_mcx(self):
        from flinttrade_webhooks.tradingview import _VALID_EXCHANGES
    ...
    def test_valid_products(self):
        from flinttrade_webhooks.tradingview import _VALID_PRODUCTS
        assert "MIS" in _VALID_PRODUCTS
        assert "CNC" in _VALID_PRODUCTS
        assert "NRML" in _VALID_PRODUCTS

    def test_valid_pricetypes(self):
        from flinttrade_webhooks.tradingview import _VALID_PRICETYPES
    ...
    def test_valid_actions(self):
        from flinttrade_webhooks.tradingview import _VALID_ACTIONS
