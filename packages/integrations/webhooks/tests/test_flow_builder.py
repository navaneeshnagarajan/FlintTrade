...
class TestLegacyEnums:
    ...
    def test_condition_types(self):
        from flinttrade_webhooks.flow_builder import ConditionType
    ...
    def test_action_types(self):
        from flinttrade_webhooks.flow_builder import ActionType
    ...
    def test_exit_types(self):
        from flinttrade_webhooks.flow_builder import ExitType
...
class TestNodeTypeEnum:
    def test_total_count_is_54(self):
        from flinttrade_webhooks.flow_builder import NodeType
...
class TestNodeRegistry:
    def test_registry_has_54_entries(self):
        from flinttrade_webhooks.flow_builder import NODE_REGISTRY
        assert len(NODE_REGISTRY) == 54

    def test_every_node_type_has_a_spec(self):
        from flinttrade_webhooks.flow_builder import NODE_REGISTRY, NodeType
        for nt in NodeType:
    ...
    def test_every_spec_has_category(self):
        from flinttrade_webhooks.flow_builder import NODE_REGISTRY, NodeCategory
        for nt, spec in NODE_REGISTRY.items():
    ...
    def test_get_node_spec_by_enum(self):
        from flinttrade_webhooks.flow_builder import NodeType, get_node_spec
        spec = get_node_spec(NodeType.PLACE_ORDER)
        assert spec.label == "Place Order"

    def test_get_node_spec_by_string(self):
        from flinttrade_webhooks.flow_builder import get_node_spec
    ...
    def test_get_all_node_types(self):
        from flinttrade_webhooks.flow_builder import get_all_node_types
        all_types = get_all_node_types()
        assert len(all_types) == 54

    def test_nodes_by_category(self):
        from flinttrade_webhooks.flow_builder import NODES_BY_CATEGORY, NodeCategory
    ...
    def test_get_node_types_by_category(self):
        from flinttrade_webhooks.flow_builder import NodeCategory, NodeType, get_node_types_by_category
...
class TestNodeCreationAllTypes:
    ...
    def test_create_all_54_node_types(self):
        from flinttrade_webhooks.flow_builder import FlowBuilder, NodeType
...
class TestFlowDefinition:
    def test_add_node(self):
        from flinttrade_webhooks.flow_builder import FlowDefinition, FlowNode
...
class TestValidationResult:
    ...
    def test_empty_flow_invalid(self):
        from flinttrade_webhooks.flow_builder import FlowDefinition, validate_flow
...
class TestFlowBuilderLegacyAPI:
    ...
    def test_add_condition_returns_id(self):
        from flinttrade_webhooks.flow_builder import ConditionType, FlowBuilder
        fb = FlowBuilder("Test")
    ...
    def test_add_action_returns_id(self):
        from flinttrade_webhooks.flow_builder import ActionType, FlowBuilder
        fb = FlowBuilder("Test")
        aid = fb.add_action(ActionType.PLACE_ORDER)
        assert aid.startswith("act_")

    def test_add_exit_returns_id(self):
        from flinttrade_webhooks.flow_builder import ExitType, FlowBuilder
        fb = FlowBuilder("Test")
    ...
    def test_build_returns_flow_definition(self):
        from flinttrade_webhooks.flow_builder import FlowBuilder, FlowDefinition
...
class TestEndToEndFlowNewAPI:
    ...
    def test_serialization_roundtrip_new_api(self):
        ...
        from flinttrade_webhooks.flow_builder import FlowBuilder, FlowDefinition, NodeType
