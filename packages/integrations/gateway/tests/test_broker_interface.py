...
Run with::
    ...
    python -m pytest packages/integrations/gateway/tests/test_broker_interface.py -v --import-mode=importlib
"""
...
def _make_broker(client: Any | None = None):
    ...
    from flinttrade_gateway.broker_interface import OpenAlgoBroker
...
class TestBrokerModels:
    ...
    def test_broker_credentials_defaults(self):
        ...
        from flinttrade_gateway.broker_interface import BrokerCredentials
    ...
    def test_auth_result_success(self):
        ...
        from flinttrade_gateway.broker_interface import AuthResult
    ...
    def test_order_request_defaults(self):
        ...
        from flinttrade_gateway.broker_interface import OrderRequest
    ...
    def test_order_response_defaults(self):
        ...
        from flinttrade_gateway.broker_interface import OrderResponse
    ...
    def test_position_model(self):
        ...
        from flinttrade_gateway.broker_interface import Position
    ...
    def test_funds_info_defaults_inr(self):
        ...
        from flinttrade_gateway.broker_interface import FundsInfo
    ...
    def test_quote_model(self):
        ...
        from flinttrade_gateway.broker_interface import Quote
    ...
    def test_holding_defaults_cnc(self):
        ...
        from flinttrade_gateway.broker_interface import Holding
...
class TestBrokerInterfaceProtocol:
    ...
    def test_openalgo_broker_is_broker_interface(self):
        ...
        from flinttrade_gateway.broker_interface import BrokerInterface, OpenAlgoBroker
    ...
    def test_non_conforming_object_fails_isinstance(self):
        ...
        from flinttrade_gateway.broker_interface import BrokerInterface
    ...
    def test_duck_typed_adapter_passes(self):
        ...
        from flinttrade_gateway.broker_interface import (
            AuthResult,
            BrokerCredentials,
            BrokerInterface,
            FundsInfo,
...
class TestBrokerRegistry:
    ...
    def _make_registry(self):
        from flinttrade_gateway.broker_interface import BrokerRegistry
