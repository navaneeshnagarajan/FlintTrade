...
Run with:
    python -m pytest packages/core/tests/test_docs_search.py -v --import-mode=importlib
"""
...
class TestDocsIndex:
    ...
    def test_tokenise_strips_markdown_syntax(self):
        from packages.core.src.docs_search_routes import _tokenise
    ...
    def test_build_empty_dir(self, tmp_path):
        from packages.core.src.docs_search_routes import DocsIndex
...
class TestExtractTitle:
    def test_extracts_first_h1(self):
        from packages.core.src.docs_search_routes import _extract_title
...
class TestExtractSnippet:
    def test_prefers_line_with_most_query_terms(self):
        from packages.core.src.docs_search_routes import _extract_snippet
...
def docs_app(tmp_path_factory, monkeypatch_module):
    ...
    from packages.core.src import docs_search_routes as dsr
