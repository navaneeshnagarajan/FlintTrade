# packages/core/tests/test_password_reset.py
...
class TestResetToken:
    ...
    def test_invalid_token_string(self):
        from packages.core.src.auth_routes import _verify_reset_token
...
class TestForgotPasswordEndpoint:
    ...
    def test_returns_200_for_valid_email(self, app_with_auth):
        ...
        with patch("packages.core.src.auth_routes.Message") as mock_msg_cls:
