"""Tests for packages/core/src/plugin_loader.py.
...
from packages.core.src.plugin_loader import (
    PluginContext,
    PluginError,
    PluginInterface,
    PluginLoader,
...
def _write_plugin(
    ...
    path.write_text(
        f"""from packages.core.src.plugin_loader import PluginInterface, PluginContext
