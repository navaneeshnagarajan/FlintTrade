# packages/core/tests/test_system_metrics.py
...
class TestSystemMetricsModel:
    def test_default_values_are_zero(self):
        from packages.core.src.system_metrics import SystemMetrics
...
class TestGetSystemMetricsPsutilAvailable:
    ...
    def test_returns_populated_metrics(self):
        import packages.core.src.system_metrics as sm_module
...
class TestAdminSystemRoute:
    ...
    def test_route_returns_200_with_metrics(self, monkeypatch):
        ...
        with app.test_client() as c:
            with patch(
                "packages.core.src.system_metrics.get_system_metrics",
