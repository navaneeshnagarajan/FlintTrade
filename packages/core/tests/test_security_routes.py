...
class TestGetStats:
    def test_empty_stats(self, client):
        resp = client.get("/ft-api/v1/security/stats")
...
class TestGetBans:
    def test_empty_bans_list(self, client):
        resp = client.get("/ft-api/v1/security/bans")
        assert resp.status_code == 200
        data = resp.get_json()
...
class TestGetRecords:
    def test_records_after_requests(self, client, monitor):
        ...
        resp = client.get("/ft-api/v1/security/records")
        assert resp.status_code == 200
