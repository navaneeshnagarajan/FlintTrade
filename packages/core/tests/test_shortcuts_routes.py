...
Run with:
    python -m pytest packages/core/tests/test_shortcuts_routes.py -v --import-mode=importlib
"""
...
def reset_module_state():
    ...
    import packages.core.src.shortcuts_routes as sr
    sr._reset_conn()
    yield
    sr._reset_conn()
...
class TestGetShortcuts:
    ...
    def test_returns_saved_overrides(self, client, in_memory_conn):
        ...
        from packages.core.src.shortcuts_routes import _save_overrides
