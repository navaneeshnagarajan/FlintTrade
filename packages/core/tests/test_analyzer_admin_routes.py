"""Tests for packages/core/src/analyzer_admin_routes.py (Flask Blueprint).
...
def client(analyzer: MagicMock):
    ...
    """
    from packages.core.src.analyzer_admin_routes import create_analyzer_admin_blueprint
