"""Contract test — `packages/terminal/src/services/api.ts` ↔ Flask order routes.
...
_API_TS = _REPO_ROOT / "packages" / "terminal" / "src" / "services" / "api.ts"
...
def _backend_order_route_leaves() -> set[str]:
    ...
    """
    from packages.core.src.app import create_flask_app  # noqa: PLC0415
