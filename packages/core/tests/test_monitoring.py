...
Run with:
    python -m pytest packages/core/tests/test_monitoring.py -v --import-mode=importlib
"""
...
class TestHealthAggregator:
    ...
    def _make(self):
        from packages.core.src.monitoring import HealthAggregator
...
class TestTrafficCounter:
    ...
    def _make(self):
        from packages.core.src.monitoring import TrafficCounter
...
class TestLatencyTracker:
    ...
    def _make(self):
        from packages.core.src.monitoring import LatencyTracker
