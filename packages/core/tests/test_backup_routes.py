"""Tests for packages/core/src/backup_routes.py (Flask Blueprint).
...
def client(tmp_path):
    ...
    Yields:
        Flask test client.
    """
    from packages.core.src.backup_routes import create_backup_blueprint
...
class TestBackupCreate:
    def test_create_backup_success(self, client, tmp_path) -> None:
        ...
        with patch(
            "packages.core.src.backup.WorkspaceBackup.create_backup",
    ...
    def test_create_backup_error_returns_500(self, client) -> None:
        ...
        Args:
            client: Flask test client.
        """
        from packages.core.src.backup import BackupError
...
class TestBackupRestore:
    ...
    def test_restore_success(self, client) -> None:
        ...
        with patch(
            "packages.core.src.backup.WorkspaceBackup.restore_backup",
...
class TestBackupList:
    def test_list_returns_empty_when_no_backups(self, client) -> None:
        ...
        """
        with patch(
            "packages.core.src.backup.WorkspaceBackup.list_backups",
            return_value=[],
        ):
