...
Run with:
    python -m pytest packages/core/historical/tests/test_intervals_routes.py -v --import-mode=importlib
"""
...
from flinttrade_historical.intervals_routes import intervals_bp
