...
_BUILTIN_PRESETS: list[WorkspacePreset] = [
    WorkspacePreset(
        ...
        widgets=["chart", "orderladder", "orderpad", "positions", "scalper", "pnlmonitor"],
        layout={},
        is_builtin=True,
        created_at=_EPOCH,
        updated_at=_EPOCH,
    ...
    WorkspacePreset(
        ...
        widgets=["watchlist", "marketoverview", "news", "ticker", "oichart"],
        layout={},
        is_builtin=True,
        created_at=_EPOCH,
        updated_at=_EPOCH,
    ...
    WorkspacePreset(
        ...
        widgets=["pnlmonitor", "riskdashboard", "positions", "actioncenter", "indexstrip"],
        layout={},
        is_builtin=True,
        created_at=_EPOCH,
        updated_at=_EPOCH,
