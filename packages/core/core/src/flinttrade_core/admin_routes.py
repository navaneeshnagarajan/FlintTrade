...
_WIDGET_REGISTRY: list[dict[str, str]] = [
    ...
    {"id": "fills", "name": "Fills", "category": "Trading", "status": "live"},
    {"id": "pnlmonitor", "name": "P&L Monitor", "category": "Trading", "status": "live"},
    ...
    {"id": "marketoverview", "name": "Market Overview", "category": "Analysis", "status": "live"},
