...
lifecycle events fire::
    ...
    from flinttrade_core.cache import Cache, wire_to_event_bus
    from flinttrade_core.event_bus import bus
...
def wire_to_event_bus(cache: Cache, event_bus: Any) -> None:
    ...
    Args:
        ...
        event_bus: :class:`~flinttrade_core.event_bus.EventBus` instance.
    """
