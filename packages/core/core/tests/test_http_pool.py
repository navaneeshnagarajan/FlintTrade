"""Tests for packages/core/core/src/http_pool.py.
...
from flinttrade_core.http_pool import HTTPClientPool
...
async def test_request_retries_on_500() -> None:
    ...
    with patch.object(httpx.AsyncClient, "request", new=_mock_request):
        with patch("flinttrade_core.http_pool.asyncio.sleep", new=AsyncMock()):
