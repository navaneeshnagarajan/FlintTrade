...
Run with:
    python -m pytest packages/core/core/tests/test_ip_whitelist.py -v --import-mode=importlib
"""
...
from flinttrade_core.ip_whitelist import IPWhitelist, _parse_network
