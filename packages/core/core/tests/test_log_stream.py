...
Run with:
    python -m pytest packages/core/core/tests/test_log_stream.py -v --import-mode=importlib
"""
...
class TestLogBuffer:
    ...
    def test_max_buffer_cap(self, log_buffer):
        ...
        from flinttrade_core.log_stream import _MAX_BUFFER
...
class TestInstallLogCapture:
    ...
    def test_capture_logs(self, log_buffer):
        ...
        from flinttrade_core.log_stream import install_log_capture
