...
Run with:
    python -m pytest packages/core/core/tests/test_security_routes.py -v --import-mode=importlib
"""
...
from flinttrade_core.security_routes import register_security_middleware, security_bp
