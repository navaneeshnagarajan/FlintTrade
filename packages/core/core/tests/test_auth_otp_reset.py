# packages/core/core/tests/test_auth_otp_reset.py
...
def client(tmp_path):
    ...
    with patch("flinttrade_core.auth_routes._get_auth_service") as mock_svc:
...
class TestOtpHelpers:
    def setup_method(self):
        ...
        import flinttrade_core.auth_routes as ar

        ar._OTP_STORE.clear()
        ar._OTP_REQUEST_LOG.clear()

    def test_generate_otp_is_6_digits(self):
        from flinttrade_core.auth_routes import _generate_otp
    ...
    def test_store_and_verify_otp_succeeds(self):
        from flinttrade_core.auth_routes import _store_otp, _verify_and_consume_otp
    ...
    def test_verify_unknown_email_returns_false(self):
        from flinttrade_core.auth_routes import _verify_and_consume_otp
...
class TestEmailTransportSmtp:
    def test_send_otp_via_smtp(self):
        from flinttrade_core.auth_routes import EmailTransport
