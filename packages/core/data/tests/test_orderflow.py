...
def _make_agg(tick_size: float = 50.0, interval_minutes: int = 5):
    from flinttrade_data.orderflow import OrderFlowAggregator
...
class TestDataclassProperties:
    def test_footprint_cell_total_volume(self):
        from flinttrade_data.orderflow import FootprintCell
    ...
    def test_footprint_bucket_total_volume(self):
        from flinttrade_data.orderflow import FootprintBucket, FootprintCell
...
class TestConstructorValidation:
    ...
    def test_default_timestamp_uses_time_now(self, monkeypatch):
        ...
        import flinttrade_data.orderflow as orderflow_mod
