...
def _make_client(**kwargs: Any):
    ...
    from flinttrade_data.questdb_client import QuestDBClient
...
class TestGracefulImport:
    def test_module_imports_without_psycopg2(self):
        ...
        mod_key = "flinttrade_data.questdb_client"
...
class TestConnectWithoutPsycopg2:
    def test_connect_raises_when_psycopg2_missing(self):
        ...
        from flinttrade_data.questdb_client import QuestDBClient, QuestDBClientError

        client = QuestDBClient()
        with patch("flinttrade_data.questdb_client._PSYCOPG2_AVAILABLE", False):
            try:
                client.connect()
...
class TestCreateTables:
    ...
    def test_create_tables_raises_and_rolls_back_on_failure(self):
        from flinttrade_data.questdb_client import QuestDBClientError
...
class TestGenerateCandles:
    ...
    def test_generate_candles_returns_ohlcv_list(self):
        from flinttrade_data.questdb_client import OHLCV
...
class TestGetMarketStats:
    def test_get_market_stats_returns_market_stats_dataclass(self):
        from flinttrade_data.questdb_client import MarketStats
...
class TestCoerceTs:
    def test_none_returns_utcnow(self):
        from flinttrade_data.questdb_client import _coerce_ts
...
class TestIntervalToTruncUnit:
    def test_known_intervals(self):
        from flinttrade_data.questdb_client import _interval_to_trunc_unit
    ...
    def test_unknown_interval_raises(self):
        from flinttrade_data.questdb_client import (
            QuestDBClientError,
...
class TestParseTsArg:
    def test_parses_iso_string(self):
        from flinttrade_data.questdb_client import _parse_ts_arg
    ...
    def test_raises_on_invalid_string(self):
        from flinttrade_data.questdb_client import QuestDBClientError, _parse_ts_arg
