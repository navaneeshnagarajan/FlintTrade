"""Tests for packages/core/data/src/audit_export.py.

Covers: CSV export, PDF export (mocked if reportlab missing),
        summary stats, date range handling, error paths.

Run with:
    python -m pytest packages/core/data/tests/test_audit_export.py -v --import-mode=importlib
"""
...
from flinttrade_data.audit_export import AuditExporter, AuditExportError
