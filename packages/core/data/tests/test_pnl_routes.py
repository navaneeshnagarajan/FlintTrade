...
Run with:
    python -m pytest packages/core/data/tests/test_pnl_routes.py -v --import-mode=importlib
"""
...
def app_client(monkeypatch_module):
    ...
    **Why function-scope, not module-scope:**
    ...
    from flinttrade_data.pnl_routes import init_pnl_routes
...
def test_init_pnl_routes():
    from flinttrade_journal.pnl_tracker import PnLTracker
    from flinttrade_data.pnl_routes import init_pnl_routes
    import flinttrade_data.pnl_routes as pnl_routes
