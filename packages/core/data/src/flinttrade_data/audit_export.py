"""Export the local audit log to CSV and PDF.
...
Usage::
    ...
    from flinttrade_data.audit_export import AuditExporter
...
class AuditExporter:
    ...
    Args:
        audit_logger: An :class:`~flinttrade_data.audit_logger.AuditLogger`
