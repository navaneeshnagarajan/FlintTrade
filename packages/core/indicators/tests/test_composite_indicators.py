...
class TestWilliamsVixFix:
    ...
    def test_wvf_shape(self) -> None:
        ...
        from flinttrade_indicators.volatility import williams_vix_fix
...
class TestDPO:
    ...
    def test_dpo_shape(self) -> None:
        """Output shape must match input length."""
        from flinttrade_indicators.momentum import dpo
...
class TestEFI:
    ...
    def test_efi_shape(self) -> None:
        """Output shape must match input length."""
        from flinttrade_indicators.volume import efi
...
class TestPVT:
    ...
    def test_pvt_shape(self) -> None:
        """Output shape must match input length."""
        from flinttrade_indicators.volume import pvt
...
class TestChaikinVolatility:
    ...
    def test_chaikin_vol_shape(self) -> None:
        """Output shape must match input length."""
        from flinttrade_indicators.volatility import chaikin_volatility
