"""Tests for packages/core/indicators — all pure Python/NumPy indicators.
...
class TestEMA:
    def test_ema_shorter_than_period_returns_all_nan(self):
        from flinttrade_indicators.trend import ema
...
class TestDEMA:
    def test_dema_faster_lag_than_ema(self):
        ...
        from flinttrade_indicators.trend import dema, ema
    ...
    def test_dema_constant_series_equals_constant(self):
        from flinttrade_indicators.trend import dema
...
class TestVWAP:
    def test_vwap_equal_volume_equals_typical_price(self):
        ...
        from flinttrade_indicators.trend import vwap
...
class TestRSI:
    ...
    def test_rsi_uptrend_overbought(self):
        from flinttrade_indicators.momentum import rsi
...
class TestMACD:
    def test_macd_uptrend_line_positive(self):
        ...
        from flinttrade_indicators.momentum import macd
...
class TestStochastic:
    def test_stochastic_k_range_0_to_100(self):
        from flinttrade_indicators.momentum import stochastic
...
class TestWilliamsR:
    def test_williams_r_range_minus100_to_0(self):
        from flinttrade_indicators.momentum import williams_r
...
class TestATR:
    def test_atr_constant_range_equals_range(self):
        ...
        from flinttrade_indicators.volatility import atr
...
class TestKeltnerChannels:
    def test_keltner_upper_gt_middle_gt_lower(self):
        from flinttrade_indicators.volatility import keltner_channels
...
class TestUtils:
    def test_validate_series_rejects_list(self):
        from flinttrade_indicators.utils import validate_series
    ...
    def test_validate_ohlcv_rejects_mismatched_lengths(self):
        from flinttrade_indicators.utils import validate_ohlcv
