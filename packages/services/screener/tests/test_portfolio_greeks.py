...
def _make_position(
    ...
    from flinttrade_screener.greeks import OptionPosition
...
class TestIVPercentile:
    def test_returns_zero_for_single_element(self):
        from flinttrade_screener.portfolio_greeks import iv_percentile
...
class TestIVRank:
    def test_returns_zero_for_single_element(self):
        from flinttrade_screener.portfolio_greeks import iv_rank
...
class TestGreeksPnlAttribution:
    def test_delta_pnl_proportional_to_spot_move(self):
        from flinttrade_screener.portfolio_greeks import greeks_pnl_attribution
...
class TestPortfolioPcr:
    def test_equal_ce_and_pe_lots_returns_one(self):
        from flinttrade_screener.portfolio_greeks import portfolio_pcr
...
class TestMaxPainEnhanced:
    ...
    def test_returns_max_pain_result(self):
        from flinttrade_screener.portfolio_greeks import max_pain_enhanced, MaxPainResult
    ...
    def test_pain_by_strike_has_all_strikes(self):
        from flinttrade_screener.portfolio_greeks import max_pain_enhanced
...
class TestEnhancedPortfolioGreeks:
    def test_calculate_enhanced_aggregates_greeks(self):
        from flinttrade_screener.portfolio_greeks import EnhancedPortfolioGreeks
        from flinttrade_core.models import OptionGreek
    ...
    def test_attribute_pnl_via_static_method(self):
        from flinttrade_screener.portfolio_greeks import EnhancedPortfolioGreeks
        from flinttrade_screener.greeks import PortfolioGreeksResult
