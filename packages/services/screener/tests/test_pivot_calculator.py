...
Run with:
    python -m pytest packages/services/screener/tests/test_pivot_calculator.py -v --import-mode=importlib
"""
...
def _calc(high: float, low: float, close: float, open_price=None, method=None):
    from flinttrade_screener.pivot_calculator import PivotCalculator, PivotMethod
...
class TestPivotLevels:
    ...
    def test_standard_model_creation(self):
        from flinttrade_screener.pivot_calculator import PivotLevels, PivotMethod
        levels = PivotLevels(
...
class TestStandardPivot:
    ...
    def test_method_label(self):
        from flinttrade_screener.pivot_calculator import PivotMethod
        levels = _calc(self.H, self.L, self.C)
...
class TestAllMethods:
    ...
    def _all(self, open_price=None):
        from flinttrade_screener.pivot_calculator import PivotCalculator
    ...
    def test_each_value_is_pivot_levels(self):
        from flinttrade_screener.pivot_calculator import PivotLevels
        result = self._all()
