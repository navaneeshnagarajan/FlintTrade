...
from flinttrade_screener.tv_signals import TVAnalysisResult, TVSignals
...
class TestTVSignals:
    ...
    @patch("flinttrade_screener.tv_signals.TA_Handler", create=True)
    def test_get_analysis_success(self, mock_handler_cls: MagicMock):
        ...
        with patch("flinttrade_screener.tv_signals.TA_Handler", mock_handler_cls, create=True):
            # We need to mock the import inside the function
            import flinttrade_screener.tv_signals as mod
    ...
    def test_exchange_mapping(self):
        from flinttrade_screener.tv_signals import _EXCHANGE_MAP
