...
def _clear_cache():
    ...
    import flinttrade_screener.mf_routes as mod
    mod._funds_cache = []
...
def app():
    ...
    from flinttrade_screener.mf_routes import mf_bp
...
def client(app):
    ...
    with patch("flinttrade_screener.mf_routes.urlopen", side_effect=_mock_fetch):
...
class TestAMFIParser:
    ...
    def test_parse_returns_list(self):
        from flinttrade_screener.mf_routes import _parse_amfi_nav
