...
class TestVolSurfaceStructure:
    ...
    def test_result_has_strikes(self):
        from flinttrade_screener.vol_surface import calculate_vol_surface
...
class TestBlack76IV:
    ...
    def test_iv_solver_atm_option(self):
        from flinttrade_screener.vol_surface import _black76_iv, _black76_call
    ...
    def test_iv_solver_zero_time_returns_zero(self):
        from flinttrade_screener.vol_surface import _black76_iv
    ...
    def test_black76_call_price_positive(self):
        from flinttrade_screener.vol_surface import _black76_call
