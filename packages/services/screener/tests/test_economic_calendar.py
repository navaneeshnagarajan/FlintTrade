...
Run with:
    python -m pytest packages/services/screener/tests/test_economic_calendar.py -v --import-mode=importlib
"""
...
class TestEconomicEvent:
    ...
    def _make_event(self, **kwargs):
        from flinttrade_screener.economic_calendar import EconomicEvent
...
class TestEconomicCalendarProvider:
    ...
    def test_load_from_list_replaces_cache(self):
        from flinttrade_screener.economic_calendar import (
