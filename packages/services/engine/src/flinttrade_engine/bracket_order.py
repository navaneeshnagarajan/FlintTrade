...
from flinttrade_core.models import Action, Exchange, Order, OrderResponse, PriceType, Product
...
class BracketOrderService:
    ...
    def cancel_bracket(self, bracket_id: str) -> bool:
        ...
        if self._client is not None:
            from flinttrade_core.models import CancelOrder  # local import avoids top-level cycle
