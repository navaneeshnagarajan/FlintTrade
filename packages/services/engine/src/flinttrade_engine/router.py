...
registry, the order is routed to a :class:`~flinttrade_engine.sandbox.SandboxEngine`
...
from flinttrade_core.models import Order, OrderResponse, Position
...
class SandboxAccountConfig:
    ...
    Attributes:
        account_id: The account identifier. When an order's ``strategy`` field
            ...
            :class:`~flinttrade_engine.sandbox.SandboxEngine` instead of the
            live broker.
