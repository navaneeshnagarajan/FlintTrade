...
:func:`flinttrade_core.order_routes._dispatch_order` so engine routes
...
def _decode_payload() -> dict[str, Any] | None:
    ...
    """
    from flinttrade_core.auth_routes import decode_token  # lazy to avoid import cycle
...
def require_live_unlocked(view: Callable[..., Any]) -> Callable[..., Any]:
    ...
    :func:`flinttrade_core.order_routes._dispatch_order` at the route
    boundary:
