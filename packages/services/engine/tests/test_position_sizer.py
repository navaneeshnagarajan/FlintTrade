"""Tests for packages/services/engine/src/position_sizer.py and the /api/v1/position/size endpoint.
...
@pytest.fixture()
def sizer():
    from flinttrade_engine.position_sizer import PositionSizer
    return PositionSizer


@pytest.fixture()
def app():
    from flinttrade_engine.position_sizer_routes import position_bp
