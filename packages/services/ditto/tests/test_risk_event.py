...
class TestRiskEvent:
    ...
    def _event(self, **overrides):
        from flinttrade_ditto.risk_manager import (
            RiskActionTaken,
            RiskEvent,
            RiskEventType,
        )
    ...
    def test_empty_exit_order_ids_by_default(self):
        from flinttrade_ditto.risk_manager import RiskEvent, RiskEventType
...
class TestRiskEventLog:
    ...
    def _log(self, max_events: int = 100):
        from flinttrade_ditto.risk_manager import RiskEventLog
        return RiskEventLog(max_events=max_events)

    def _event(self, event_type: str = "max_loss", account_id: str = "acc-001"):
        from flinttrade_ditto.risk_manager import RiskEvent
