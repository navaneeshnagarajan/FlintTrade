...
Run with:
    python -m pytest packages/services/automation/tests/test_flow_nodes.py -v --import-mode=importlib
"""
...
def _ctx(**variables):
    from flinttrade_automation.flow_nodes.base import FlowContext  # noqa: PLC0415
...
class TestAndGate:
    ...
    def test_all_true(self):
        from flinttrade_automation.flow_nodes import AndGate  # noqa: PLC0415
...
class TestOrGate:
    ...
    def test_one_true(self):
        from flinttrade_automation.flow_nodes import OrGate  # noqa: PLC0415
...
class TestNotGate:
    ...
    def test_negate_true(self):
        from flinttrade_automation.flow_nodes import NotGate  # noqa: PLC0415
...
class TestXorGate:
    ...
    def test_different_values(self):
        from flinttrade_automation.flow_nodes import XorGate  # noqa: PLC0415
        ctx = _ctx(a=True, b=False)
...
class TestDelayNode:
    ...
    def test_delay_zero_succeeds(self):
        from flinttrade_automation.flow_nodes import DelayNode  # noqa: PLC0415
...
class TestHTTPRequestNode:
    ...
    def test_successful_get(self):
        from flinttrade_automation.flow_nodes import HTTPRequestNode  # noqa: PLC0415
    ...
    def test_url_placeholder_resolution(self):
        ...
        with patch(
            "flinttrade_automation.flow_nodes.http_node._validate_public_url"
...
class TestIfThenElseNode:
    ...
    def test_true_branch_taken(self):
        from flinttrade_automation.flow_nodes import IfThenElseNode  # noqa: PLC0415
    ...
    def test_true_branch_nodes_executed(self):
        from flinttrade_automation.flow_nodes import IfThenElseNode, MathNode  # noqa: PLC0415
...
class TestSwitchNode:
    ...
    def test_matching_case(self):
        from flinttrade_automation.flow_nodes import SwitchNode  # noqa: PLC0415
        ctx = _ctx(mode="buy")
...
class TestMathNode:
    ...
    def test_add(self):
        from flinttrade_automation.flow_nodes import MathNode  # noqa: PLC0415
...
class TestAlertNode:
    ...
    def test_log_channel_always_succeeds(self):
        from flinttrade_automation.flow_nodes import AlertNode  # noqa: PLC0415
...
class TestOrderNode:
    ...
    def test_successful_order(self):
        from flinttrade_automation.flow_nodes import OrderNode  # noqa: PLC0415
...
class TestFlowExecutorLinear:
    ...
    def test_linear_all_succeed(self):
        from flinttrade_automation.flow_nodes import FlowExecutor, MathNode  # noqa: PLC0415
        nodes = [
    ...
    def test_linear_empty_list(self):
        from flinttrade_automation.flow_nodes import FlowExecutor  # noqa: PLC0415
...
class TestFlowExecutorDAG:
    ...
    def test_dag_topological_order(self):
        from flinttrade_automation.flow_nodes import FlowExecutor, MathNode  # noqa: PLC0415
        from flinttrade_automation.flow_nodes.executor import NodeSpec  # noqa: PLC0415
...
class TestFlowContext:
    ...
    def test_set_and_get(self):
        from flinttrade_automation.flow_nodes import FlowContext  # noqa: PLC0415
        ctx = FlowContext()
        ctx.set("key", 42)
