...
def _make_bridge(llm_content: str | None = None, llm_success: bool = True):
    ...
    from flinttrade_automation.voice_order_bridge import VoiceOrderBridge
...
class TestVoiceOrderIntent:
    ...
    def test_is_high_risk_cancel(self):
        from flinttrade_automation.voice_order_bridge import VoiceOrderIntent
...
class TestVoiceOrderBridgeExecute:
    ...
    def test_execute_raises_low_confidence(self):
        import asyncio
        from flinttrade_automation.voice_order_bridge import LowConfidenceError, VoiceOrderIntent
    ...
    def test_execute_high_risk_requires_approval(self):
        import asyncio
        from flinttrade_automation.voice_order_bridge import PendingApprovalError, VoiceOrderIntent
