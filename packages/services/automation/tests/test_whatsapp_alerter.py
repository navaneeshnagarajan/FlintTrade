# packages/services/automation/tests/test_whatsapp_alerter.py
...
if TYPE_CHECKING:  # forward-ref for `-> "WhatsAppAlerter"` annotations below
    from flinttrade_automation.whatsapp_alerter import WhatsAppAlerter
...
class TestAlertRouterChannels:
    def test_default_signal_goes_to_both_channels(self):
        from flinttrade_automation.whatsapp_alerter import AlertRouter, AlertRouterConfig
...
class TestAlertRouterDelivery:
    def _router_with_mocks(self, tg_enabled=True, wa_enabled=True):
        from flinttrade_automation.whatsapp_alerter import (
            AlertRouter,
            AlertRouterConfig,
            WhatsAppAlerter,
        )
...
class TestAlertRouterConfigFromWorkspace:
    def test_returns_defaults_when_workspace_unavailable(self):
        from flinttrade_automation.whatsapp_alerter import AlertRouterConfig

        with patch(
            "flinttrade_automation.whatsapp_alerter.AlertRouterConfig.from_workspace",
