"""Tests for packages/services/automation/src/n8n_routes.py — n8n workflow integration."""
...
import flinttrade_automation.n8n_routes as mod
from flinttrade_automation.n8n_bridge import N8nBridgeError
