...
class TestAgentAnalysis:
    ...
    def test_defaults(self) -> None:
        from flinttrade_ai.agent_models import AgentAnalysis
...
class TestTradeRecommendation:
    ...
    def test_from_team_analysis_counts_signals(self) -> None:
        from flinttrade_ai.agent_models import AgentAnalysis, TeamAnalysis, TradeRecommendation
...
class TestAgentTeamAnalyze:
    ...
    def test_analyze_returns_team_analysis(self) -> None:
        from flinttrade_ai.agent_models import TeamAnalysis
...
class TestMajorityVoteFallback:
    ...
    def test_majority_vote_picks_winner(self) -> None:
        from flinttrade_ai.agent_models import AgentAnalysis, TeamAnalysis
...
class TestResearchIteration:
    ...
    def test_default_values(self) -> None:
        from flinttrade_ai.multi_agent import ResearchIteration
...
class TestAutonomousResearchLoop:
    ...
    def test_basic_loop_runs_all_iterations(self) -> None:
        from flinttrade_ai.multi_agent import AutonomousResearchLoop
        team, _, _ = _make_team(
    ...
    def test_loop_handles_failures_gracefully(self) -> None:
        from flinttrade_ai.multi_agent import AutonomousResearchLoop, AgentTeam
