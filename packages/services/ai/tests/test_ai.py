...
class TestLLMClient:
    ...
    def test_estimate_tokens(self):
        from flinttrade_ai.llm_client import estimate_tokens
        assert estimate_tokens("hello world") >= 2
        assert estimate_tokens("") == 1

    def test_fits_context(self):
        from flinttrade_ai.llm_client import LLMClient, LLMConfig, LLMMessage
...
class TestRAG:
    ...
    def test_chunk_short_text(self):
        from flinttrade_ai.rag import chunk_text
    ...
    def test_content_hash_stable(self):
        from flinttrade_ai.rag import content_hash
    ...
    def test_document_creation(self):
        from flinttrade_ai.rag import Document
        doc = Document(
    ...
    def test_retrieved_chunk_dataclass(self):
        from flinttrade_ai.rag import RetrievedChunk
    ...
    def test_rag_response_success(self):
        from flinttrade_ai.rag import RAGResponse
...
class TestSignals:
    ...
    def test_compute_rsi(self):
        from flinttrade_ai.signals import compute_rsi
    ...
    def test_compute_ema(self):
        from flinttrade_ai.signals import compute_ema
    ...
    def test_compute_bollinger_pct(self):
        from flinttrade_ai.signals import compute_bollinger_pct
        closes = [100.0] * 30
    ...
    def test_signal_dataclass(self):
        from flinttrade_ai.signals import Signal
...
class TestSentiment:
    ...
    def test_extract_symbols(self):
        from flinttrade_ai.sentiment import extract_symbols
    ...
    def test_rule_based_sentiment_bullish(self):
        from flinttrade_ai.sentiment import NewsArticle, score_article_rule_based
        article = NewsArticle(
    ...
    def test_aggregate_sentiment(self):
        from flinttrade_ai.sentiment import SentimentScore, aggregate_sentiment
        scores = [
    ...
    def test_aggregate_empty(self):
        from flinttrade_ai.sentiment import aggregate_sentiment
        agg = aggregate_sentiment([], "NIFTY")
        assert agg.article_count == 0
        assert agg.net_score == 0

    def test_detect_shifts(self):
        from flinttrade_ai.sentiment import SentimentAnalyzer, SentimentScore
        prev = [
    ...
    def test_analyzer_init(self):
        from flinttrade_ai.sentiment import SentimentAnalyzer
...
class TestMCPBridge:
    ...
    def test_tool_definitions_valid(self):
        from flinttrade_ai.mcp_bridge import TOOL_DEFINITIONS
...
class TestAdvisor:
    ...
    def _make_stocks(self):
        from flinttrade_ai.advisor import StockFeatures
        return [
            StockFeatures(
    ...
    def test_simple_rank_without_model(self):
        from flinttrade_ai.advisor import StockAdvisor
    ...
    def test_features_to_array(self):
        from flinttrade_ai.advisor import StockFeatures, features_to_array
    ...
    def test_portfolio_suggestion_properties(self):
        from flinttrade_ai.advisor import PortfolioSuggestion, StockRanking
...
class TestPackageExports:
    ...
    def test_version(self):
        from flinttrade_ai import __version__
