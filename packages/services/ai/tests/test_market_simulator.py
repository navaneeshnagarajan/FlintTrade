...
class TestMarketParticipant:
    ...
    def test_creation(self):
        from flinttrade_ai.market_simulator import MarketParticipant
    ...
    def test_default_participants_count(self):
        from flinttrade_ai.market_simulator import DEFAULT_PARTICIPANTS
...
class TestParticipantAction:
    def test_creation(self):
        from flinttrade_ai.market_simulator import ParticipantAction
...
class TestParseResponse:
    def test_parse_buy(self):
        from flinttrade_ai.market_simulator import _parse_response
...
class TestAggregate:
    def test_majority_buy(self):
        from flinttrade_ai.market_simulator import ParticipantAction, _aggregate
    ...
    def test_empty_actions(self):
        from flinttrade_ai.market_simulator import _aggregate
...
class TestMarketSimulatorSync:
    def test_simulate_sync_basic(self):
        from flinttrade_ai.market_simulator import MarketSimulator
    ...
    def test_simulate_sync_custom_participants(self):
        from flinttrade_ai.market_simulator import MarketParticipant, MarketSimulator
...
class TestMarketSimulatorExports:
    ...
    def test_simulation_result_dataclass(self):
        from flinttrade_ai.market_simulator import SimulationResult
