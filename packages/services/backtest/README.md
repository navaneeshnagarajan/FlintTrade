...
> Strategy simulator, walk-forward and Monte Carlo testing, portfolio backtester, and 95 strategy template modules across 6 categories.
...
- `src/flinttrade_backtest/strategies/ — 95 ready-to-run template modules`
