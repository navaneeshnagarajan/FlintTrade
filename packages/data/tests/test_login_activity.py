...
Run with:
    python -m pytest packages/data/tests/test_login_activity.py -v --import-mode=importlib
"""
...
def _make_login_activity():
    from packages.data.src.activity_log import LoginActivity

    return LoginActivity(":memory:")


def _make_session_tracker():
    from packages.data.src.activity_log import SessionTracker

    return SessionTracker(":memory:")


def _make_security_tracker():
    from packages.data.src.security_tracker import SecurityTracker
