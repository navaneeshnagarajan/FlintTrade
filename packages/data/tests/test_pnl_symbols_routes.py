...
Run with:
    python -m pytest packages/data/tests/test_pnl_symbols_routes.py -v --import-mode=importlib
"""
...
from packages.data.src.pnl_symbols_routes import pnl_symbols_bp, init_pnl_symbols_routes
