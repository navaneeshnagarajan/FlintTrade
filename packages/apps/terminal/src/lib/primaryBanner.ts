 ...
 * banner. Priority: Explore / Practice > Live risk > money-path incident >
 * feed disconnected > edge / Chat.
...
export function selectPrimaryBanner(input: {
  ...
  const incidentOutranksFeed = incident !== null
    && incident.failureClass !== "llm"
    && incident.failureClass !== "edge";
