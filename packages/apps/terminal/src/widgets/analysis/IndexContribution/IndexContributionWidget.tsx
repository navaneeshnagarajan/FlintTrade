/**
 * IndexContributionWidget — index movers by constituent weight (W7).
 *
 ...
 * when connected; otherwise a clearly-marked sample.
 */
...
function IndexContributionWidget() {
...
export default memo(IndexContributionWidget);
