/**
 * PortfolioRRGView -- custom symbol portfolio plotted on the RRG canvas.
 *
 * Carried over from the retired SectorMap widget's Portfolio mode into the
 * Market Overview Rotation tab. The localStorage key is unchanged so symbol
 * lists saved under the old widget survive the merge.
 *
...
export const PortfolioRRGView = memo(function PortfolioRRGView() {
