...
export const widgetCatalog: WidgetMeta[] = [
  ...
  { id: "orders", name: "Orders", icon: "ClipboardList", category: "Trading", description: "Order book showing pending, executed, and rejected orders" , surface: "trade", availability: "live-or-sample"},
  { id: "holdings", name: "Holdings", icon: "Wallet", category: "Trading", description: "Long-term equity and mutual fund holdings with current value" , surface: "trade", availability: "live-or-sample"},
  ...
  { id: "tradecopier", name: "Trade Copier", icon: "Copy", category: "Trading", description: "Mirror trades across multiple accounts with configurable lot multipliers" , surface: "trade", availability: "live-or-sample"},
  { id: "smartorder", name: "Smart Order", icon: "GitFork", category: "Trading", description: "Liquidity-aware order slicing (market / depth chunks / TWAP) — every child order passes the full safety gate" , surface: "trade", availability: "live-or-sample"},
  ...
  { id: "foreverorders", name: "Forever (GTT) Orders", icon: "Clock", category: "Trading", description: "Place and manage forever/GTT orders incl. OCO legs and validity — native brokers only" , surface: "trade", availability: "live-or-sample"},
  { id: "superorders", name: "Super Orders", icon: "Target", category: "Trading", description: "Bracket-style super orders with leg-aware modify and cancel — native brokers only" , surface: "trade", availability: "live-or-sample"},
  { id: "conditionaltriggers", name: "Conditional Triggers", icon: "Zap", category: "Trading", description: "Condition-based trigger orders: place, modify and cancel market-condition alerts that fire orders" , surface: "trade", availability: "live-or-sample"},
  ...
  { id: "marketoverview", name: "Market Overview", icon: "LayoutGrid", category: "Analysis", description: "Market breadth, sector performance and rotation (RRG), FII/DII flows, live NSE and global indices, and index contribution by constituent weight — one tabbed surface with per-section Live/Sample provenance", surface: "trade", availability: "live-or-sample" },
  ...
  { id: "pcrtrend", name: "PCR Trend", icon: "TrendingDown", category: "Analysis", description: "Put-Call Ratio trend line to gauge market sentiment over time — sample sessions only, no chain PCR source is wired yet" , surface: "trade", availability: "live-or-sample"},
  { id: "instrumentcompare", name: "Instrument Compare", icon: "GitCompare", category: "Analysis", description: "Percentage-change overlay of up to four instruments rebased to a common start — sample series only, no live price feed is wired yet" , surface: "trade", availability: "live-or-sample"},
  ...
  { id: "gapanalysis", name: "Gap Analysis", icon: "ArrowUpFromLine", category: "Analysis", description: "Gap-up/gap-down events with fill rate and average gap size — sample events only, no gap-history source is wired yet" , surface: "trade", availability: "live-or-sample"},
  ...
  { id: "deliverydata", name: "Delivery Data", icon: "Package", category: "Analysis", description: "Delivery percentage per scrip with open/high/low/close and traded volume, sorted into conviction bands — sample data only, no delivery source is wired yet" , surface: "trade", availability: "live-or-sample"},
  ...
  // Utility
  { id: "watchlist", name: "Watchlist", icon: "Star", category: "Utility", description: "Customisable instrument watchlist with live LTP and change data" , surface: "trade", availability: "live-or-sample"},
  { id: "indexstrip", name: "Index Strip", icon: "TrendingUp", category: "Utility", description: "Compact strip of live index cards — NIFTY 50, BANK NIFTY, SENSEX, FIN NIFTY and India VIX with change, sparkline and a VIX>20 alert border, straight from the WebSocket tick stream" , surface: "trade", availability: "live-or-sample"},
  ...
  { id: "news", name: "News Feed", icon: "Newspaper", category: "Utility", description: "Curated market news and announcements relevant to your watchlist" , surface: "trade", availability: "live-or-sample"},
  ...
  { id: "reconciliation", name: "Reconciliation", icon: "ShieldCheck", category: "Utility", description: "Broker-vs-FlintTrade reconciliation status per native account with expandable mismatch reports" , surface: "trade", availability: "live-or-sample"},
  ...
  { id: "currencyconverter", name: "Currency Converter", icon: "ArrowLeftRight", category: "Utility", description: "Convert between INR, USD, EUR, GBP, JPY, SGD and AED — static reference rates only, no FX feed is wired yet" , surface: "trade", availability: "live-or-sample"},
