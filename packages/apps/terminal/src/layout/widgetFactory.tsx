...
export const widgetCatalog: WidgetMeta[] = [
  ...
  { id: "marketoverview", name: "Market Overview", icon: "LayoutGrid", category: "Analysis", description: "Market breadth, sector performance and rotation (RRG), FII/DII flows, live NSE and global indices, and index contribution by constituent weight — one tabbed surface with a Live chip only when that section is live", surface: "shared", availability: "live-or-sample" },
