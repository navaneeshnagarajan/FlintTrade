...
// Explicit icon registry — replaces `import * as LucideIcons` to allow
// tree-shaking. Every icon name used in widgetCatalog MUST be here, or the
// picker silently renders the generic Box for that widget — at one point 38 of
// 64 catalogue icons were missing. widgetFactory.test.ts pins the sync.
