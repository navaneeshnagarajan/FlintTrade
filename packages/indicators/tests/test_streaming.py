...
class TestStreamingEMA:
    ...
    def test_converges_to_batch_ema(self):
        ...
        from packages.indicators.src.streaming import StreamingEMA
        from packages.indicators.src.trend import ema as batch_ema
...
class TestStreamingSMA:
    def test_warmup_returns_none(self):
        from packages.indicators.src.streaming import StreamingSMA
...
class TestStreamingRSI:
    def test_warmup_returns_none(self):
        from packages.indicators.src.streaming import StreamingRSI
    ...
    def test_converges_to_batch_rsi(self):
        from packages.indicators.src.streaming import StreamingRSI
        from packages.indicators.src.momentum import rsi as batch_rsi
...
class TestStreamingATR:
    def test_warmup_returns_none(self):
        from packages.indicators.src.streaming import StreamingATR
    ...
    def test_converges_to_batch_atr(self):
        ...
        from packages.indicators.src.streaming import StreamingATR
        from packages.indicators.src.volatility import atr as batch_atr
