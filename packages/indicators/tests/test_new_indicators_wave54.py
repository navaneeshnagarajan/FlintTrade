...
class TestNumbaShim:
    def test_jit_is_callable(self):
        from packages.indicators.src.numba_shim import jit
    ...
    def test_has_numba_is_bool(self):
        from packages.indicators.src.numba_shim import HAS_NUMBA

        assert isinstance(HAS_NUMBA, bool)

    def test_prange_behaves_like_range(self):
        from packages.indicators.src.numba_shim import prange
    ...
    def test_noop_decorator_preserves_function(self):
        ...
        from packages.indicators.src.numba_shim import jit, HAS_NUMBA
...
class TestALMA:
    def test_shape(self):
        from packages.indicators.src.trend import alma
...
class TestT3:
    def test_shape(self):
        from packages.indicators.src.trend import t3
...
class TestFRAMA:
    def test_shape(self):
        from packages.indicators.src.trend import frama
...
class TestMcGinleyDynamic:
    def test_shape(self):
        from packages.indicators.src.trend import mcginley_dynamic
...
class TestVIDYA:
    def test_shape(self):
        from packages.indicators.src.trend import vidya
...
class TestAlligator:
    def test_shapes(self):
        from packages.indicators.src.trend import alligator
...
class TestMovingAverageEnvelopes:
    def test_shapes(self):
        from packages.indicators.src.trend import moving_average_envelopes
...
class TestTRIMA:
    def test_shape(self):
        from packages.indicators.src.trend import trima
...
class TestFisherTransform:
    def test_shapes(self):
        from packages.indicators.src.momentum import fisher_transform
...
class TestCRSI:
    def test_shape(self):
        from packages.indicators.src.momentum import crsi
...
class TestBBPercent:
    def test_shape(self):
        from packages.indicators.src.volatility import bb_percent
...
class TestBBWidth:
    def test_shape(self):
        from packages.indicators.src.volatility import bb_width
...
class TestChandelierExit:
    def test_shapes(self):
        from packages.indicators.src.volatility import chandelier_exit
...
class TestUlcerIndex:
    def test_shape(self):
        from packages.indicators.src.volatility import ulcer_index
...
class TestSTARCBands:
    def test_shapes(self):
        from packages.indicators.src.volatility import starc_bands
...
class TestEMV:
    def test_shape(self):
        from packages.indicators.src.volume import emv
...
class TestNVI:
    def test_shape(self):
        from packages.indicators.src.volume import nvi
...
class TestKlingerVolumeOscillator:
    def test_shapes(self):
        from packages.indicators.src.volume import klinger_volume_oscillator
...
class TestOBVSmoothed:
    def test_shape(self):
        from packages.indicators.src.volume import obv_smoothed
...
class TestRVOL:
    def test_shape(self):
        from packages.indicators.src.volume import rvol
...
class TestVROC:
    def test_shape(self):
        from packages.indicators.src.volume import vroc
...
class TestFI:
    def test_shape(self):
        from packages.indicators.src.volume import fi
    ...
    def test_same_as_efi(self):
        from packages.indicators.src.volume import fi, efi
...
class TestGatorOscillator:
    def test_shapes(self):
        from packages.indicators.src.oscillators import gator_oscillator
...
class TestSTC:
    def test_shape(self):
        from packages.indicators.src.oscillators import stc
...
class TestCoppockCurve:
    def test_shape(self):
        from packages.indicators.src.oscillators import coppock_curve
...
class TestTSI:
    def test_shape(self):
        from packages.indicators.src.oscillators import tsi
...
class TestCHO:
    def test_shape(self):
        from packages.indicators.src.oscillators import cho
...
class TestCHOP:
    def test_shape(self):
        from packages.indicators.src.oscillators import chop
...
class TestKST:
    def test_shapes(self):
        from packages.indicators.src.oscillators import kst
...
class TestVortex:
    def test_shapes(self):
        from packages.indicators.src.oscillators import vortex
...
class TestAC:
    def test_shape(self):
        from packages.indicators.src.oscillators import ac
...
class TestLRSlope:
    def test_shape(self):
        from packages.indicators.src.statistics import lrslope
...
class TestCORREL:
    def test_shape(self):
        from packages.indicators.src.statistics import correl
...
class TestBETA:
    def test_shape(self):
        from packages.indicators.src.statistics import beta
...
class TestVAR:
    def test_shape(self):
        from packages.indicators.src.statistics import var
...
class TestTSF:
    def test_shape(self):
        from packages.indicators.src.statistics import tsf
...
class TestMEDIAN:
    def test_shape(self):
        from packages.indicators.src.statistics import median
...
class TestMODE:
    def test_shape(self):
        from packages.indicators.src.statistics import mode
...
class TestMedianBands:
    def test_shapes(self):
        from packages.indicators.src.statistics import median_bands
