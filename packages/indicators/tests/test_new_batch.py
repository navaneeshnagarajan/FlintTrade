...
class TestKAMA:
    def test_kama_shape(self):
        from packages.indicators.src.trend import kama
...
class TestADX:
    def test_adx_shape(self):
        from packages.indicators.src.trend import adx
...
class TestDMI:
    def test_dmi_shape(self):
        from packages.indicators.src.trend import dmi
...
class TestLinReg:
    def test_linreg_shape(self):
        from packages.indicators.src.trend import linreg
...
class TestMOM:
    def test_mom_shape(self):
        from packages.indicators.src.momentum import mom
...
class TestAwesomeOscillator:
    def test_ao_shape(self):
        from packages.indicators.src.momentum import awesome_oscillator
