...
class TestStreamingMACD:
    def test_warmup_returns_none_for_all_three(self):
        from packages.indicators.src.streaming import StreamingMACD
    ...
    def test_converges_to_batch_macd(self):
        from packages.indicators.src.streaming import StreamingMACD
        from packages.indicators.src.momentum import macd as batch_macd
...
class TestStreamingBollingerBands:
    def test_warmup_returns_none(self):
        from packages.indicators.src.streaming import StreamingBollingerBands
    ...
    def test_middle_band_equals_sma(self):
        from packages.indicators.src.streaming import StreamingBollingerBands
        from packages.indicators.src.trend import sma as batch_sma
...
class TestStreamingSupertrend:
    def test_warmup_returns_none(self):
        from packages.indicators.src.streaming import StreamingSupertrend
...
class TestStreamingVWAP:
    def test_single_bar_vwap_equals_typical_price(self):
        from packages.indicators.src.streaming import StreamingVWAP
...
class TestStreamingCumulativeDelta:
    def test_up_bar_adds_volume(self):
        from packages.indicators.src.streaming import StreamingCumulativeDelta
    ...
    def test_converges_to_batch_cumulative_delta(self):
        from packages.indicators.src.streaming import StreamingCumulativeDelta
        from packages.indicators.src.volume import cumulative_delta
...
class TestBatchVolumeProfile:
    def test_returns_correct_shapes(self):
        from packages.indicators.src.volume import volume_profile
