...
class TestDailyReport:
    def test_win_rate_with_trades(self):
        from packages.automation.src.post_market import DailyReport
    ...
    def test_to_dict_keys(self):
        from packages.automation.src.post_market import DailyReport, TradeEntry
        r = DailyReport(
...
class TestBuildReport:
    ...
    def test_unnamed_strategy_defaults_to_default(self):
        ...
        from packages.automation.src.post_market import TradeEntry, build_report
        trades = [
...
class TestFormatReportTelegram:
    ...
    def test_positive_pnl_has_green_emoji(self):
        from packages.automation.src.post_market import format_report_telegram
        msg = format_report_telegram(self._report(pnl=1500.0))
        assert "🟢" in msg

    def test_negative_pnl_has_red_emoji(self):
        from packages.automation.src.post_market import TradeEntry, build_report, format_report_telegram
    ...
    def test_llm_analysis_shown_when_set(self):
        from packages.automation.src.post_market import DailyReport, format_report_telegram
        report = DailyReport(
            report_date="2026-03-16",
            total_trades=2,
...
class TestPostMarketDuckDB:
    ...
    def test_store_report_no_path_does_not_raise(self):
        from packages.automation.src.post_market import PostMarketAnalysis, TradeEntry
...
class TestPostMarketLLM:
    ...
    def test_llm_success_adds_analysis_to_report(self):
        ...
        with patch("packages.automation.src.post_market.PostMarketAnalysis._generate_llm_analysis",
