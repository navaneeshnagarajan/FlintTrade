...
- All order placement and quote fetching go through
  :class:`~packages.core.src.openalgo_client.OpenAlgoClient`.
...
class WheelStrategy(BaseStrategy):
    ...
    Args:
        ...
        client:           :class:`~packages.core.src.openalgo_client.OpenAlgoClient`
    ...
    def generate_orders(self) -> list[Order]:
        ...
        Returns:
            List of :class:`~packages.core.src.models.Order` queued since
            the last call.
        """
    ...
    def restore_from_state(self, state: dict[str, Any]) -> None:
        ...
        Args:
            state: Dict returned by :meth:`get_state_dict` (from
                   :meth:`~packages.engine.src.strategy.BaseStrategy.load_state`).
        """
