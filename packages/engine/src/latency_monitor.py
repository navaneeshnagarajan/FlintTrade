...
Extends the in-memory :class:`~packages.core.src.monitoring.LatencyTracker`
...
Admin REST routes (registered from ``packages.core.src.app.create_flask_app``):
...
Example::
    ...
    from packages.engine.src.latency_monitor import LatencyMonitor
...
class LatencyMonitor:
    ...
    Complements the in-memory :class:`~packages.core.src.monitoring.LatencyTracker`
