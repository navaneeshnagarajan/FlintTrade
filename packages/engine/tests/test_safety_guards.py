...
class TestOvertradingGuardCooldown:
    ...
    def _guard(self, cooldown_seconds: int = 60):
        from packages.engine.src.safety import OvertradingConfig, OvertradingGuard
...
class TestMTMCircuitBreaker:
    ...
    def _breaker(self, limit: float = -50_000.0, client=None):
        from packages.engine.src.safety import MTMCircuitBreaker, MTMCircuitBreakerConfig
