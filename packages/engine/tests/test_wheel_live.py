...
def _strategy(
    ...
    from packages.engine.src.strategies.wheel_live import WheelStrategy
...
class TestWheelPhase:
    def test_phase_values(self):
        from packages.engine.src.strategies.wheel_live import WheelPhase
...
class TestWheelStrategyInit:
    ...
    def test_strategy_starts_active(self):
        from packages.engine.src.strategy import StrategyState
        strat, _ = _strategy()
...
class TestWheelRestart:
    def test_cc_expired_transitions_to_waiting_csp(self):
        from packages.engine.src.strategies.wheel_live import WheelPhase, WheelStrategy
...
def test_registered_in_engine_strategies():
    from packages.engine.src.strategies import WheelPhase, WheelStrategy
