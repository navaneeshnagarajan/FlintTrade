"""Tests for packages/engine/src/position_sizer_routes.py — position sizing endpoint."""
...
import packages.engine.src.position_sizer_routes as mod
...
def _sizer_patch(quantity: int = 5):
    ...
    return patch(
        "packages.engine.src.position_sizer.PositionSizer",
        sizer,
    )
