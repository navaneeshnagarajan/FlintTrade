"""Regression tests for ``packages.engine.src.mode_guard``.
...
- :func:`require_live_unlocked` — full explore/practice/live × locked/unlocked
  fan-out matching :func:`packages.core.src.order_routes._dispatch_order`.
...
import packages.engine.src.mode_guard as mg
