...
:class:`~packages.backtest_engine.src.walk_forward.WalkForwardAnalyser`
programmatically.
...
try:
    ...
    from permutation_test import PermutationConfig, PermutationTester  # type: ignore[no-redef]
    from walk_forward import WalkForwardAnalyser, WalkForwardConfig  # type: ignore[no-redef]
...
class _BuyAndHoldStrategy:
    ...
    :func:`~packages.backtest_engine.src.walk_forward._run_strategy_on_bars`
    can extract them.
...
def run_walk_forward() -> tuple[Response, int]:
    ...
    classes use :class:`~packages.backtest_engine.src.walk_forward.WalkForwardAnalyser`
    programmatically.
