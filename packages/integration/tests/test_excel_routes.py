"""Tests for packages/integration/src/excel_routes.py — Excel export/import endpoints."""
...
import packages.integration.src.excel_routes as mod
from packages.integration.src.excel_bridge import ExcelBridgeError
