...
packages/integration/src/__init__.py, which chains through:
...
Run with: python -m pytest packages/integration/tests/test_voice_orders.py -v
"""
...
# ---------------------------------------------------------------------------
# Direct module load — bypasses packages/integration/src/__init__.py
# ---------------------------------------------------------------------------
