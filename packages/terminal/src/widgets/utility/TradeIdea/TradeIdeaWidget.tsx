  ...
  return (
    <form onSubmit={(e) => { e.preventDefault(); submit(); }} className="space-y-2 p-2.5 bg-surface-elevated border border-border-default rounded"
      ...
      <div className="grid grid-cols-3 gap-2">
        <Input value={entry} onChange={(e) => setEntry(e.target.value)} placeholder="Entry" className="h-7 text-xs font-mono bg-surface-hover border-border-default text-text-primary" aria-label="Entry Zone" />
        <Input value={sl} onChange={(e) => setSl(e.target.value)} placeholder="Stop Loss" className="h-7 text-xs font-mono bg-surface-hover border-border-default text-text-primary" aria-label="Stop Loss" />
    ...
    <div className="h-full flex flex-col bg-surface-base overflow-hidden" aria-label="Trade Idea widget">
      <div className="flex-none flex items-center gap-2 px-2.5 py-1.5 bg-surface-card border-b border-border-default">
        ...
        <Button
          ...
          className="h-6 px-2 text-xxs font-medium bg-accent/15 text-accent border-accent/30 hover:bg-accent/25"
          aria-label="Add new trade idea"
