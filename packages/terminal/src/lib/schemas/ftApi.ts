...
// packages/core/src/auth_routes.py → auth_status()
...
// ---------------------------------------------------------------------------
// GET /ft-api/v1/tax/summary — packages/data/src/tax_routes.py → tax_summary()
...
// packages/screener/src/stock_routes.py → stock_scan()
...
// packages/data/src/sandbox_routes.py → get_capital()
...
// packages/core/src/docs_search_routes.py → search_docs()
...
// packages/screener/src/breadth_routes.py → breadth_current()
...
// packages/core/src/admin_routes.py → admin_system()
// packages/core/src/system_metrics.py → SystemMetrics.to_dict() (model_dump)
...
// packages/ai/src/advisor_routes.py → advisor_status()
...
// packages/ai/src/advisor_routes.py → advisor_chat()
