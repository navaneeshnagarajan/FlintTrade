...
#
# The origin above is the last-resort public site. The hosted /install.ps1
# redirect stays valid on a custom domain; this desktop installer does not
# read FLINTTRADE_SITE_URL (the web installer does).
#
# Parameters:
