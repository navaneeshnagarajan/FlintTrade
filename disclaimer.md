...
FlintTrade `v0.6.0-beta.1` is a beta-stage open-source project. It is **not production ready**, not a registered investment advisory product, and not a managed trading service.
