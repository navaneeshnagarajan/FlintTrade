...
- [x] **Multi-broker capability metadata:** `recommendations.py` filters broker capabilities per use case from declared `Capabilities`; `GET /api/v1/broker/recommendations`. (Honest capability metadata corrected in the 2026-06-12 pass.)
